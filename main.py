...
def writeForum():
    ...
    for x in range(len(allForumMsgs)):
        ...
        messageText = allForumMsgs[x][2]
        dateTimeText = str(allForumMsgs[x][3]) + "/" + str(allForumMsgs[x][4]) + "/" + str(allForumMsgs[x][5]) + "   " + str(allForumMsgs[x][6]) + ":" + str(allForumMsgs[x][7])
        ...
        if len(allReplies) > 0:
            ...
            for y in range(len(allReplies)):
                ...
                rMessageText = allReplies[y][3]
                rDateTimeText = str(allReplies[y][4]) + "/" + str(allReplies[y][5]) + "/" + str(allReplies[y][6]) + "   " + str(allReplies[y][7]) + ":" + str(allReplies[y][8])
    ...
    fTextBox = TextBox(fEnterMsg, text="Enter your message", width="fill", align="left")
